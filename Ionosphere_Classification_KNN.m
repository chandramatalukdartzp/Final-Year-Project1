...
%         a8=Testing_data(j,8);
%         a9=Testing_data(j,9);
%         a10=Testing_data(j,10);
%         a11=Testing_data(j,11);
%         a12=Testing_data(j,12);
%         a13=Testing_data(j,13);
%         a14=Testing_data(j,14);
%         a15=Testing_data(j,15);
%         a16=Testing_data(j,16);
        % a=5.25;
        % b=3.45;
        % c=1.72;
        % d=0.75;
